	...
	<div class="o_">
		...
		<div class="o_wrapper">
			<div class="a_">
				<div class="a_article">
					<div class="a_line">
						<p class="h2">${ delete.article_title }</p>
					</div>
					<div class="a_line">
						<p class="h4">${ delete.contribute_date }</p>
					</div>
					<div>
						<p class="a_kiji">${ delete.article_main }</p>
					</div>
				...
				<div class="a_form">
					<div class="a_btn">
						<p>
							<span class="a_denger">※この記事を削除しますか？</span>
						</p>

						<form:form action="14deleteOK" modelAttribute="form">
							<form:hidden path="article_id" />
							<form:hidden path="article_title" />
							<input class="btn btn-danger btn-lg btn-block" type="submit"
								value="削除完了"> <br> <input type="submit"
								class="btn btn-success btn-lg btn-block" name="button"
								value="編集・削除記事一覧に戻る"
								onclick="location.href='09all_edit_delete'; return false;">
							<div class="a_return">
