...
<div class="a_form">
    ...
    <div>
      ...
      <form:input class="form-control input-lg" id="title" name="title" path="title" placeholder="記事の題名" />
    </div>
    <br>
    <div>
      <label for="content" class="a_midashi">本文</label>
	  <form:textarea class="form-control  input-lg" rows="8" id="comment" path="content" placeholder="本文" />
    </div>
...
<div class="row">
	<div class="col-xs-12 col-md-6">
	  <div class="a_photos">
	  	...
	  	<p>ここに写真が表示されます</p>
	  	 	<img id="img1"  class="a_user_photo" />
	  	 	<input type="hidden" class="btn btn-danger btn-lg btn-block" value="写真①の削除" onclick="clearValue1();" id="delete1">
	  </div>
	  ...
	  <div class="a_photos">
			...
			写真を追加②<input type="file"  style="display:none" id="photo2">
	  	</label>
	  	<p>ここに写真が表示されます</p>
	  	<img id="img2"  class="a_user_photo" />
	  	<input type="hidden" class="btn btn-danger btn-lg btn-block" value="写真②の削除" onclick="clearValue2();" id="delete2">
	  ...
	  <div class="a_photos">
	  	  <label class="btn btn-default btn-lg btn-block">
			写真を追加③<input type="file"  style="display:none" id="photo3">
	  	</label>
	  	<p>ここに写真が表示されます</p>
	  	<img id="img3"  class="a_user_photo" />
	  	<input type="hidden" class="btn btn-danger btn-lg btn-block" value="写真③の削除" onclick="clearValue3();" id="delete3">
	  ...
	  <div class="a_photos">
	  	  <label class="btn btn-default btn-lg btn-block">
			写真を追加④<input type="file"  style="display:none" id="photo4">
	  	</label>
	  	<p>ここに写真が表示されます</p>
	  	<img id="img4"  class="a_user_photo" />
	  	 <input type="hidden" class="btn btn-danger btn-lg btn-block" value="写真④の削除" onclick="clearValue4();" id="delete4">
...
<div class="a_">
	<input  class="btn btn-warning btn-lg btn-block" type="submit" value="表示の確認">
	<div class="a_return">
