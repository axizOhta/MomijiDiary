					...
					<div class="row">
						<div class="col-xs-12 col-md-6">
							<div class="a_photos">
								<label class="btn btn-default btn-lg btn-block" id="a_line">
									写真を追加①<input type="file" name="file" style="display: none" id="photo1">
								</label>
								<p>ここに写真が表示されます</p>
						...
						<div class="col-xs-12 col-md-6">
							...
							<div class="a_photos">
								...
								写真を追加②<input type="file" name="file" style="display: none" id="photo2">
								</label>
								<p>ここに写真が表示されます</p>
						...
						<div class="col-xs-12 col-md-6">
							...
							<div class="a_photos">
								<label class="btn btn-default btn-lg btn-block">
								写真を追加③<input type="file" name="file" style="display: none" id="photo3">
								</label>
								<p>ここに写真が表示されます</p>
						...
						<div class="col-xs-12 col-md-6">
							...
							<div class="a_photos">
								<label class="btn btn-default btn-lg btn-block">
								写真を追加④<input type="file" name="file" style="display: none" id="photo4">
								</label>
								<p>ここに写真が表示されます</p>
